...
def parse_train_configs():
    ...
    parser.add_argument('--pretrained_path', type=str, default=r'D:\tb\SFA3D-master (1)\checkpoints\fpn_resnet_18\fpn_resnet_18_epoch_300.pth', metavar='PATH',
    ...
    ####################################################################
    configs.dataset_dir = r'E:\kitti\datas/'
