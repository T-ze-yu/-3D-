...
class PoseResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out_layer1 = self.layer1(x)             #([b, 128, 56, 56])
        out_layer2 = self.layer2(out_layer1)    #([b, 128, 28, 28])

        out_layer3 = self.layer3(out_layer2)    #([b, 256, 14, 14])

        out_layer4 = self.layer4(out_layer3)   #([b, 512, 7, 7])
